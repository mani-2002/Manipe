    ...
    <div style={{ padding: "5vh 5vh 5vh 5vh" }}>
      <div className="d-flex">
        <div>
          ...
          <div style={{ margin: "3vh 0 3vh 1vh" }}>
            ...
            <button style={{ marginLeft: "2vh" }} className="btn btn-secondary">
              <Link
                to="/signup"
                style={{ textDecoration: "none", color: "white" }}
              >
      ...
      >
        <div style={{ margin: "5vh" }}>
          ...
          <div style={{ fontSize: "10vh" }}>The New Way of Doing Business</div>
      ...
      <div style={{ margin: "5vh", marginBottom: "5vh" }}>
        ...
        <div>
          <div style={{ width: "100%", display: "flex", margin: "1vh" }}>
            ...
            <div
              style={{ border: "1px solid black", width: "31%", margin: "2vh" }}
            >
              <img
                src={safeAndSecure}
                alt=""
