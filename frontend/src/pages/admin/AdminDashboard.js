...
const AdminDashboard = ({ onLogout }) => {
  ...
  const fetchDistinctUsers = async () => {
    ...
    try {
      const response = await fetch(
        "https://manipe.onrender.com/distinct-users",
        {
          headers: {
            authorization: token,
          },
  ...
  const deleteUserByEmail = async (email) => {
    try {
      const response = await fetch(
        `https://manipe.onrender.com/delete-users/${email}`,
        {
          method: "DELETE",
        }
      );
  ...
  useEffect(() => {
    const token = localStorage.getItem("token");
    fetch("https://manipe.onrender.com/transaction-history", {
      headers: {
        authorization: token,
      },
    })
  ...
  useEffect(() => {
    const token = localStorage.getItem("token");
    fetch("https://manipe.onrender.com/transactions", {
      headers: {
        Authorization: token,
      },
    })
  ...
  const fetchSuggestions = async (input) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await fetch(
        `https://manipe.onrender.com/suggestions?email=${input}`,
        {
          headers: {
            Authorization: token,
          },
  ...
  const handleSearchSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await fetch(
        `https://manipe.onrender.com/search?email=${email}`,
        {
          headers: {
            Authorization: token,
          },
