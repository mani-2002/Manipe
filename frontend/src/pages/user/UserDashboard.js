...
const UserDashboard = ({ onLogout }) => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://manipe.onrender.com/api/link-bank-account",
        {
          method: "POST",
          headers: {
  ...
  useEffect(() => {
    ...
    const token = localStorage.getItem("token");
    fetch("https://manipe.onrender.com/api/user-details", {
      method: "GET",
      headers: {
        Authorization: token,
      },
  ...
  const handleUnlink = (accountNumber) => {
    const token = localStorage.getItem("token");
    fetch(`https://manipe.onrender.com/api/delete-account/${accountNumber}`, {
      method: "DELETE",
      headers: {
        Authorization: token,
      },
  ...
  const handleRadioChange = async (event, accountNumber) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://manipe.onrender.com/api/set-primary-account",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const fetchBalance = async (accountNumber) => {
    ...
    try {
      const response = await fetch(
        `https://manipe.onrender.com/api/balance/${accountNumber}`,
        {
          method: "GET",
          headers: {
            Authorization: token,
  ...
  useEffect(() => {
    const token = localStorage.getItem("token");
    fetch("https://manipe.onrender.com/api/user-emails", {
      method: "GET",
      headers: {
        Authorization: token,
      },
  ...
  const handleUserSelect = async (event) => {
    ...
    if (selectedEmail === "") {
      ...
      const token = localStorage.getItem("token");
      const response = await fetch(
        `https://manipe.onrender.com/api/user-details/${selectedEmail}`,
        {
          method: "GET",
          headers: {
            Authorization: token,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://manipe.onrender.com/transfer", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: token,
  ...
  const handleMobSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://manipe.onrender.com/mob-transfer", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: token,
  ...
  const handleUpiSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://manipe.onrender.com/upi-transfer", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: token,
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `https://manipe.onrender.com/user-transactions`,
          {
            method: "GET",
            headers: {
              Authorization: token,
